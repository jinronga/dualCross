...
type Data struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ipdb          *IpDBInfo              `protobuf:"bytes,1,opt,name=ipdb,proto3" json:"ipdb,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IpDBInfo struct {
	...
	Region        *Ip2Region             `protobuf:"bytes,2,opt,name=region,proto3" json:"region,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *IpDBInfo) Reset() {
	*x = IpDBInfo{}
...
func (x *IpDBInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IpDBInfo) ProtoMessage() {}

func (x *IpDBInfo) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IpDBInfo.ProtoReflect.Descriptor instead.
func (*IpDBInfo) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *IpDBInfo) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *IpDBInfo) GetRegion() *Ip2Region {
	if x != nil {
		return x.Region
	}
	return nil
...
func (x *Ip2Region) GetDbPath() string {
	if x != nil {
		return x.DbPath
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*IpDBInfo)(nil),            // 3: kratos.api.IpDBInfo
	(*Ip2Region)(nil),           // 4: kratos.api.ip2region
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3, // 4: kratos.api.Data.ipdb:type_name -> kratos.api.IpDBInfo
	4, // 5: kratos.api.IpDBInfo.region:type_name -> kratos.api.ip2region
